...
public class XWikiLowercaseAlphabeticalListInterpreterV09 extends AbstractInterpreter 
{
	...
	{
		super();
		this.encodingTag = KnownEncodingForm.LOWERCASE_ALPHABETICAL_LIST_ENCODING_FORM.getPattern();
		this.decodingTag = KnownDecodingForm.LOWERCASE_ALPHABETICAL_LIST_DECODING_FORM.getPattern();
	}

	@Override
	public String encode(String content) 
	{
		Pattern encodingPattern	= Pattern.compile(KnownEncodingPatterns.LOWERCASE_ALPHABETICAL_LIST_INTERPRETER_PATTERN.getPattern(),Pattern.MULTILINE);
	...
	{
		Pattern decodingPattern = Pattern.compile(KnownDecodingPatterns.LOWERCASE_ALPHABETICAL_LIST_DECODING_PATTERN.getPattern());
