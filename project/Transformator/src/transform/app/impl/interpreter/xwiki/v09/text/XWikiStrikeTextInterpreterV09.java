...
/**
 * Interpreter for the strike text in XWiki 0.9
 * @author Razvan
 *
 */
...
{
	/**
	 *  The logger for the class {@link XWikiStrikeTextInterpreterV09}
	 */
	private static final Logger log = Logger.getLogger(XWikiStrikeTextInterpreterV09.class);
	...
	{
		log.info("Start to encode the strike text from XWiki 0.9 ...");
	...
	{
		log.info("Start to decode the strike text into XWiki 0.9 syntax ...");
