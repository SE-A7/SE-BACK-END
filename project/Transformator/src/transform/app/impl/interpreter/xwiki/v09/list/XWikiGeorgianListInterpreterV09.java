...
public class XWikiGeorgianListInterpreterV09 extends AbstractInterpreter 
{
	private static final String GEORGIAN_LIST_INTERPRETER_PATTERN 	= "<ul style=\"list-style-type: georgian\">([\\p{Space}]*<li>[\\p{Graph}\\p{Space}]*?<\\/li>[\\p{Space}]*)+<\\/ul>";
	private static final String GEORGIAN_LIST_DECODING_PATTERN		= "<list style=\"list-style-type: georgian\">([\\p{Space}]*<listItem>[\\p{Graph}\\p{Space}]*?<\\/listItem>[\\p{Space}]*)+<\\/list>";
	...
	{
		Pattern encodingPattern = Pattern.compile(GEORGIAN_LIST_INTERPRETER_PATTERN);
	...
	{
		Pattern decodingPattern = Pattern.compile(GEORGIAN_LIST_DECODING_PATTERN);
